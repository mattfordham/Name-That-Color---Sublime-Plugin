...
class NameThatColorCommand(sublime_plugin.TextCommand):
  ...
  def run(self, edit):
    ...
    for i in range(0, len(self.color_names)):
      current_color = self.color_names[i]
      color = "#" + current_color[0]
      rgb = self.rgb(color)
      hsl = self.hsl(color)
      current_color.extend((rgb[0], rgb[1], rgb[2], hsl[0], hsl[1], hsl[2]))
  ...
  def color_name(self, color):
    ...
    for i in range(0, len(self.color_names)):
      ...
      ndf1 = pow(r - current_color[2], 2) + pow(g - current_color[3], 2) + pow(b - current_color[4], 2)
      ndf2 = pow(h - current_color[5], 2) + pow(s - current_color[6], 2) + pow(l - current_color[7], 2)
